  ...
  <q-layout view="hHh lpR fFf" class="bg-grey-1">
    <q-header elevated class="bg-white text-grey-8" height-hint="64">
      <q-toolbar class="GNL__toolbar">
        ...
        <q-toolbar-title v-if="$q.screen.gt.xs" shrink class="row items-center no-wrap" color="yellow">
          <img src="/frontend/public/Adimian logo.png">
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          <q-btn v-if="$q.screen.gt.sm" round dense flat color="yellow" icon="apps">
    ...
    <div>
      <div>
        <button id="first_track" class="choice_course">
          <h4 >Level 0 Fundamentals</h4>
        </button>
      </div>
      <div>
        <button id="second_track" class="choice_course">
          <h4 id="1">Level 1 - Technical Literacy</h4>

        </button>
      </div>
      <div>
        <button id="third_track" class="choice_course">
          <h4 id="2">Level 2 - Design/Architecture</h4>

        </button>
      </div>
      <div>
        <button id="fourth_track" class="choice_course">
          <h4 id="3">Level 3 - Collaborations</h4>

        </button>
      </div>
      <div>
        <button id="fifth_track" class="choice_course">
          <h4 id="4">Level 4 - Leadership and accountability</h4>

        </button>
      </div>
      <div>
        <button id="sixth_track" class="choice_course">
          <h4 id="5">Level 5 - Vision</h4>
...
<style>
  ...
  #fourth_track{
    background-color:rgb(119, 84, 247);
  }

  #fifth_track{
    background-color:rgb(4, 224, 158);
  }

  #sixth_track{
    background-color:rgb(80, 0, 133);
  }
</style>
<script>
import { ref } from 'vue'
